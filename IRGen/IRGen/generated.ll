...
@current_gen = common global [240000 x i32] zeroinitializer, align 16
@next_gen = common global [240000 x i32] zeroinitializer, align 16
...
define dso_local void @_Z7DrawGenv() local_unnamed_addr {
...
19:                                               ; preds = %10
  ...
  call void @_Z11SimPutPixeliii(i32 %20, i32 %21, i32 -65536)
  br label %22
...
define dso_local void @_Z11CalcNextGenv() local_unnamed_addr {
  %1 = alloca i32, align 4
  %2 = alloca i32, align 4
